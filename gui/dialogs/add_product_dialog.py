...
class AddProductDialog(ctk.CTkToplevel):
    ...
    def _setup_ui(self):
        ...
        self.codigo_entry = ctk.CTkEntry(
            ...
            placeholder_text="Ingrese el código"
        )
        ...
        self.precio_compra_entry = ctk.CTkEntry(
            ...
            border_color="#333333",
            placeholder_text_color="#888888",
            placeholder_text="Ingrese el precio de compra"
        )
        ...
        self.precio_venta_entry = ctk.CTkEntry(
            ...
            border_color="#333333",
            placeholder_text_color="#888888",
            placeholder_text="Ingrese el precio de venta"
        )
        ...
        self.stock_entry = ctk.CTkEntry(
            ...
            border_color="#333333",
            placeholder_text_color="#888888",
            placeholder_text="Ingrese la cantidad en stock"
        )
        ...
        add_button.grid(row=6, column=0, columnspan=2, sticky="ew", pady=30, ipadx=20)
    ...
    def _on_add(self):
        ...
        try:
            exito, mensaje = inventory_manager.agregar_producto(
                codigo, nombre, precio_compra, precio_venta, stock
            )
